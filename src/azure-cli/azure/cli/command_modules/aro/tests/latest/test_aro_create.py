...
class AzureAroScenarioTest(ScenarioTest):
    ...
    def test_aro_create(self, resource_group):
        ...
        self.cmd('aro create -g {rg} -n {name} --subscription {subscription} --master-subnet {master_subnet} --worker-subnet {worker_subnet} --tags foo=doo', checks=[
